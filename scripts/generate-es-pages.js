...
const pages = [
  // Homepage
  {
    ...
    contentBlocks: [
      ...
      ['Turistas Internacionais', 'Reservas Internacionales'],
      ['Facilidades para Visitantes Internacionais', 'Cómo Reservar desde Sudamérica'],
      ['Pagamento Internacional', 'Pago Fácil desde tu País'],
      ['Aceitamos pagamentos internacionais via PIX, cartão de crédito e transferência. Entre em contato para saber a cotação do dia.', 'Aceptamos PIX vía Wise o Astropay (sin costos adicionales). Tarjetas internacionales Visa/Mastercard. Precios desde R$ 2.300 por paseo de 5 horas, hasta 15 personas (~$450 USD — unos $30 USD/persona).'],
      ['Atendimento Multilíngue', 'Atención en Español'],
      ['Nossa equipe atende em português, inglês e espanhol via WhatsApp. Respondemos em minutos com preços e disponibilidade.', 'Reserve por WhatsApp en español. Nuestro equipo responde en minutos. El marinero habla español básico. Instrucciones de seguridad en español antes de zarpar.'],
      ['Localização Privilegiada', 'Cómo Llegar + Entrada Mercosur'],
      ['Estamos na Marina da Glória, a principal marina do Rio de Janeiro, cercada pelos cartões postais da cidade. A 30 min do Aeroporto GIG e 15 min do Santos Dumont. Recomendamos hospedagem em Leblon, Ipanema ou Copacabana.', 'Ciudadanos de Argentina, Uruguay, Paraguay, Chile, Colombia, Ecuador y Perú entran a Brasil solo con DNI/cédula. Vuelos directos desde Buenos Aires, Santiago y Bogotá. Estamos en la principal marina de Río, a 30 min del aeropuerto GIG y 15 min de Santos Dumont. Recomendamos hospedaje en Leblon, Ipanema o Copacabana.'],
      ...
      ['Solicite um orçamento para aluguel de lancha no RJ em minutos.\n            Nossa equipe vai sugerir a melhor lancha para seu grupo e ocasião.', 'Escríbanos por WhatsApp en español. Respondemos en minutos\n            con precios y disponibilidad para sus fechas.'],
      ...
      ['Ideal para grupos de 8 a 20 amigas. Roteiro mais popular: Mureta da Urca com parada para fotos no Pão de Açúcar.', ''],
      ...
      ['<li>Pague 50% de sinal via PIX ou cartão</li>', '<li>Pague 50% de seña vía Wise, Astropay, tarjeta internacional o PIX</li>'],
      ...
      ['<li>Decoração rosa e branca (opcional)</li>', '<li>PIX vía Wise o Astropay — sin costos adicionales</li>'],
      ['<li>Drinks e espumante (open bar opcional)</li>', '<li>Tarjetas internacionales Visa/Mastercard</li>'],
      ['<li>Som com playlist personalizada</li>', '<li>Precios en R$ (BRL) con referencia en USD</li>'],
      ['<li>Parada para fotos com cenário icônico</li>', '<li>Precio final confirmado por WhatsApp</li>'],
      // FAQ item 4: replace bachelorette link with contact link (runs after replaceInternalLinks converted href)
      ['<a href="/es/despedida-de-soltera/">Ver pacotes de despedida de solteira →</a>', '<a href="/es/contacto/">Conozca las opciones de pago →</a>'],
      ...
      ['Passeio privativo de lancha com as melhores vistas do mundo.\n          Do Pão de Açúcar às Ilhas Cagarras, viva experiências inesquecíveis\n          no mar com conforto e segurança.', 'Navegue frente al Pan de Azúcar, Cristo Redentor y las Ilhas Cagarras\n          en una lancha privada. Reserve desde Sudamérica — aceptamos pago vía Wise y Astropay.'],
      ...
      ['É simples: você escolhe a lancha, define data e roteiro, paga 50% de sinal para reservar, e no dia combina com o marinheiro na Marina da Glória.', 'Es simple: usted elige la lancha, define fecha y ruta, paga 50% de seña vía Wise, Astropay, tarjeta internacional o PIX, y el día se encuentra con el marinero en la Marina da Glória.'],
      ['Como funciona a despedida de solteira na lancha?', '¿Cómo pago desde otro país?'],
      ['A despedida de solteira na lancha é um dos passeios mais pedidos. Oferecemos pacotes com decoração temática, drinks e até brincadeiras.', 'Aceptamos PIX vía Wise o Astropay, sin costos adicionales. También aceptamos tarjetas internacionales Visa/Mastercard. Un paseo de 5 horas cuesta desde R$ 2.300 (~$450 USD). El precio final se confirma al reservar por WhatsApp.'],
  ...
  },
  {
    ...
    esPath: 'es/lanchas/weboat-420/index.html',
    title: 'WeBoat 420 - Lancha con Flybridge para 12 Personas | WeBoat Brasil',
    description: 'Alquile la WeBoat 420 con flybridge exclusivo para hasta 12 personas. Desde R$ 2.700.',
    keywords: 'weboat ibiza 42, lancha flybridge rio, lancha 12 personas',
    waMessage: '¡Hola! Me interesa la lancha WeBoat 420. ¿Podrían enviarme más información? [via site - es]',
    css: 'lancha-detalhe',
    contentBlocks: [
      ...
      ['A WeBoat 420 tem capacidade para ate <strong>12 pessoas</strong>, incluindo criancas. Essa capacidade e definida pela Marinha do Brasil para garantir conforto e seguranca de todos a bordo.', 'La WeBoat 420 tiene capacidad para hasta <strong>12 personas</strong>, incluyendo niños. Esta capacidad está definida por la Marina de Brasil para garantizar confort y seguridad de todos a bordo.'],
      // Schema FAQ answer (JSON-LD not protected)
      ['A WeBoat 420 tem capacidade para ate 12 pessoas, incluindo criancas. Essa capacidade e definida pela Marinha do Brasil para garantir conforto e seguranca de todos a bordo.', 'La WeBoat 420 tiene capacidad para hasta 12 personas, incluyendo niños. Esta capacidad está definida por la Marina de Brasil para garantizar confort y seguridad de todos a bordo.'],
      ['O que esta incluso no aluguel da WeBoat 420?', '¿Qué está incluido en el alquiler de la WeBoat 420?'],
      ['O aluguel da WeBoat 420 inclui: combustivel para o roteiro contratado, tripulacao habilitada (marinheiro), tapete flutuante, macarroes flutuantes, som com Bluetooth, coolers e coletes salva-vidas.', 'El alquiler de la WeBoat 420 incluye: combustible para la ruta contratada, tripulación habilitada (marinero), alfombra flotante, fideos flotantes, sonido Bluetooth, hieleras y chalecos salvavidas.'],
      ['O que e o flybridge da WeBoat 420?', '¿Qué es el flybridge de la WeBoat 420?'],
      ['O flybridge e um segundo andar ao ar livre na parte superior da lancha, com solario, churrasqueira e vista panoramica 360 graus. E o diferencial exclusivo da WeBoat 420 entre as lanchas proprias WeBoat.', 'El flybridge es un segundo piso al aire libre en la parte superior de la lancha, con solárium, parrilla y vista panorámica 360 grados. Es el diferencial exclusivo de la WeBoat 420 entre las lanchas propias WeBoat.'],
      ['O valor da hora extra na WeBoat 420 e de R$ 800. A solicitacao deve ser feita durante o passeio diretamente com o marinheiro, sujeita a disponibilidade da embarcacao.', 'El valor de la hora extra en la WeBoat 420 es de R$ 800. La solicitud debe hacerse durante el paseo directamente con el marinero, sujeta a la disponibilidad de la embarcación.'],
      ['Flybridge Exclusivo', 'Flybridge Exclusivo'],
      ...
      ['Reservar pelo WhatsApp', 'Reservar por WhatsApp'],
      ['Montar Proposta', 'Armar Propuesta'],
      ['Sobre a WeBoat 420', 'Sobre la WeBoat 420'],
      ['A WeBoat 420 e a unica lancha propria da frota com flybridge — um segundo andar ao ar livre com solario, churrasqueira e vista panoramica 360 graus. Com 42 pes e capacidade para 12 pessoas, oferece uma experiencia diferenciada para quem busca espaco ao ar livre e conforto.', 'La WeBoat 420 es la única lancha propia de la flota con flybridge — un segundo piso al aire libre con solárium, parrilla y vista panorámica de 360 grados. Con 42 pies y capacidad para 12 personas, ofrece una experiencia diferenciada para quienes buscan espacio al aire libre y confort.'],
      ...
      ['A partir de', 'Desde'],
      ['Duvidas', 'Preguntas'],
      ['Perguntas Frequentes sobre a WeBoat 420', 'Preguntas Frecuentes sobre la WeBoat 420'],
      ['Quantas pessoas cabem na WeBoat 420?', '¿Cuántas personas caben en la WeBoat 420?'],
      ...
      ['A WeBoat 420 tem churrasqueira?', '¿La WeBoat 420 tiene parrilla?'],
      ...
      ['O flybridge e um <strong>segundo andar ao ar livre</strong> na parte superior da lancha. Na WeBoat 420, ele conta com solario, churrasqueira e vista panoramica 360 graus. E o diferencial exclusivo desta lancha entre as proprias WeBoat.', 'El flybridge es un <strong>segundo piso al aire libre</strong> en la parte superior de la lancha. En la WeBoat 420, cuenta con solárium, parrilla y vista panorámica de 360 grados. Es el diferencial exclusivo de esta lancha entre las propias WeBoat.'],
      ['O que esta incluso no aluguel?', '¿Qué está incluido en el alquiler?'],
      ['O aluguel da WeBoat 420 inclui: combustivel para o roteiro contratado, tripulacao habilitada, tapete flutuante, macarroes flutuantes, som com Bluetooth, coolers e coletes salva-vidas.', 'El alquiler de la WeBoat 420 incluye: combustible para la ruta contratada, tripulación habilitada, alfombra flotante, fideos flotantes, sonido con Bluetooth, coolers y chalecos salvavidas.'],
      ['Ver Todas as Duvidas', 'Ver Todas las Preguntas'],
      ['Monte sua proposta', 'Arme su propuesta'],
      ['Personalize seu Passeio na WeBoat 420', 'Personalice su Paseo en la WeBoat 420'],
      ...
      // CTA
      ['Reserve a WeBoat 420 Agora', 'Reserve la WeBoat 420 Ahora'],
  ...
  },
  {
    ...
    css: 'sobre',
      ...
      [
            "A WeBoat possui <strong>5 lanchas próprias</strong> (WeBoat 32, WeBoat 390, WeBoat Oceanic 36, WeBoat Rio Star 50 e WeBoat 420), com capacidade de 12 a 22 pessoas. Também trabalhamos com <strong>lanchas parceiras</strong> para grupos de 10 a 65 pessoas.",
            "WeBoat cuenta con <strong>5 lanchas propias</strong> (WeBoat 32, WeBoat 390, WeBoat Oceanic 36, WeBoat Rio Star 50 y WeBoat 420), con capacidad de 12 a 22 personas. También trabajamos con <strong>lanchas asociadas</strong> para grupos de 10 a 65 personas."
      ],
      [
      ...
      ['A WeBoat possui 5 lanchas próprias (WeBoat 32, WeBoat 390, WeBoat Oceanic 36, WeBoat Rio Star 50 e WeBoat 420), com capacidade de 12 a 22 pessoas. Também trabalhamos com lanchas parceiras para grupos de 10 a 65 pessoas.', 'WeBoat cuenta con 5 lanchas propias (WeBoat 32, WeBoat 390, WeBoat Oceanic 36, WeBoat Rio Star 50 y WeBoat 420), con capacidad de 12 a 22 personas. También trabajamos con lanchas asociadas para grupos de 10 a 65 personas.'],
  ...
  },
  {
    ...
    css: 'faq',
      ...
      ['A WeBoat tem 5 lanchas próprias: WeBoat 32 (15 pessoas), WeBoat 390 (16 pessoas), WeBoat Oceanic 36 (14 pessoas), WeBoat Rio Star 50 (22 pessoas) e WeBoat 420 (12 pessoas). Para grupos maiores, temos lanchas parceiras de 10 a 65 pessoas.', 'WeBoat tiene 5 lanchas propias: WeBoat 32 (15 personas), WeBoat 390 (16 personas), WeBoat Oceanic 36 (14 personas), WeBoat Rio Star 50 (22 personas) y WeBoat 420 (12 personas). Para grupos más grandes, tenemos lanchas asociadas de 10 a 65 personas.'],
      ...
      ['<strong>WeBoat 420:</strong> Até 12 pessoas (flybridge exclusivo)', '<strong>WeBoat 420:</strong> Hasta 12 personas (flybridge exclusivo)'],
      ...
      ['<strong>WeBoat 420:</strong> Flybridge exclusivo, até 12 pessoas, ideal para casais e grupos pequenos', '<strong>WeBoat 420:</strong> Flybridge exclusivo, hasta 12 personas, ideal para parejas y grupos pequeños'],
...
const translations = [
  ...
  ['"inLanguage": "pt-BR"', '"inLanguage": "es"'],
  // --- Navigation & UI ---
...
pages.forEach(page => {
  ...
  const waTextReplacements = [
    ...
    ['sobre a WeBoat 420 para o Carnaval', 'sobre la WeBoat 420 para el Carnaval'],
    ...
    ['sobre a WeBoat 420 para o réveillon', 'sobre la WeBoat 420 para el Año Nuevo'],
